...
public final class MessageSystemImpl implements MessageSystem {
    ...
    private final Collection<Socket> clientMap = new ConcurrentLinkedQueue<Socket>();
    ...
    private BiConsumer<Socket, Message> messageConsumer;
